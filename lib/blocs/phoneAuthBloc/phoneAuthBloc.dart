...
import './phoneAuthEvent.dart';
import './phoneAuthState.dart';

class PhoneAuthenticationBloc
    extends Bloc<PhoneAuthenticationEvent, PhoneAuthenticationState> {
  final AuthRepository userRepository;

  PhoneAuthenticationBloc(this.userRepository) : super(InitialAuthenticationState());

  @override
  PhoneAuthenticationState get initialState => InitialAuthenticationState();
  ...
  Stream<PhoneAuthenticationState> mapEventToState(
    ...
    if (event is AppStarted) {
      final bool hasToken = await userRepository.getCurrentUser() != null;
    ...
    if (event is PhoneLoggedIn) {
      yield Loading();
      yield Authenticated();
    }

    if (event is PhoneLoggedOut) {
      yield Loading();
      yield Unauthenticated();
    }
  }
...
// import '../../models/phoneAuthModel.dart';
// import '../../repositories/phoneAuthRepository.dart';
// import 'package:bloc/bloc.dart';
