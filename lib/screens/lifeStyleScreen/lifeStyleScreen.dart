              ...
              children: [
                Expanded(
                  ...
                  children: [
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          _selectedReligion = _religions[i];
                                        });
                                      },
                                      child: Container(
                                        padding:
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          _selectedRnStatus = _rnStatuses[i];
                                          lifeStyle!.relationshipStatus = i;
                                        });
                                      },
                                      child: Container(
                                        padding:
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          _selectedWorkout = _workouts[i];
                                          lifeStyle!.physicalExercise = i;
                                        });
                                      },
                                      child: Container(
                                        padding:
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          _selectedDrinking = _drinkings[i];
                    ...
                    SizedBox(height: 12),
                    BlocBuilder<LifeStyleBloc, LifeStyleState>(
                      // bloc: LifeStyleBloc(
